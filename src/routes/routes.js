...
import DashboardLayoutAluno from 'src/pages/Dashboard/Layout/DashboardLayoutAluno.vue';
...
const DashboardP = () => import( 'src/pages/Dashboard/Dashboard/DashboardProfessor.vue');
const Sala = () => import('src/pages/Dashboard/Dashboard/Sala.vue');
const SalaA = () => import('src/pages/Dashboard/Dashboard/SalaAluno.vue');
...
const routes = [
    ...
    children: [
      {
        path: 'dashboard',
        name: 'Professor',
        components: { default: DashboardP, header: DefaultHeader }
      },
      {
        path: 'sala',
        name: 'Sala',
        components: { default: Sala, header: DefaultHeader }
      },
  ...
  {
    path: '/',
    component: DashboardLayoutAluno,
    ...
    children: [
      {
        ...
        name: 'Aluno',
        components: {default: DashboardA, header: DefaultHeader }
      },
      {
        path: 'sala_aluno',
        name: 'Sala de Questões',
        components: { default: SalaA, header: DefaultHeader }
      },
      {
        path: 'pergunta_aluno',
        name: 'Respostas',
        components: { default: PerguntaA, header: DefaultHeader }
      }
    ]
  },
