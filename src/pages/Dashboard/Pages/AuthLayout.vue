  ...
  <div>
    <navbar :show-navbar="showMenu">
      <div class="navbar-wrapper">
        ...
        <a class="navbar-brand" href="#">Forum Educacional</a>
      </div>
      <!--
        ...
        <footer class="footer">
          ...
          <div class="container-fluid">
            ...
            <div class="copyright">
              &copy; {{year}},
              Desenvolvido por
              <a href="https://github.com/JoaoQueroga94" target="_blank">João Queroga</a>
              e <a href="https://github.com/JoaoQueroga94" target="_blank" >Fábio Michel</a>.
            </div>
          </div>
        </footer>
